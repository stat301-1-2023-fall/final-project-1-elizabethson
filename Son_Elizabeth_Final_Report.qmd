...
> Eastern Asia: The tradeoff between productivity and unemployment rate is significant. As unemployment rises even marginally, there is a strong negative relationship between productivity and unemployment rate that leads to a significant drop in productivity. Happiness, however, does not experience a similarly dramatic drop. Countries in Eastern Asia have a smaller range in happiness that is skewed toward lower levels of happiness. Thus, the drop in happiness is insignificant in the context of a happiness scale from 0 to 10. 

> Western Europe: Countries in Western Europe also experience a negative relationship between productivity and unempoyment rate. However, this negative relationship is not as strong- as unemployment rate increases, productivity decreases marginally. Countries in Western Europe also have a wide range of happiness, with the happiest countries having the lowest unemployment rates with varying levels of productivity. 

While the multivariate analysis does not completely visualize the three-variable relationship while factoring for region, it does complement past analyses by showing that a significant relationship does exist in some regions. 

### Time Trends
To further analyze the relationship between productivity and happiness, and how they interact over time, @fig-10 reveals the top 10 countries in terms of happiness score and productivity. 
...
There are many ways to determine the "most" happy and productive country. The approach I used here was to filter the dataset by the top 40 happiest countries in 2019. @fig-10 then ranks these countries by productivity. According to the table, Luxembourg is the happiest and most productive country, followed by Ireland and Singapore.

@fig-11, @fig-12, and @fig-13 reveal that the top 3 countries all experienced rising productivity over time from 2015 to 2019. Further, they reveal that at lower levels of productivity, the top 3 countries had higher happiness scores. 
